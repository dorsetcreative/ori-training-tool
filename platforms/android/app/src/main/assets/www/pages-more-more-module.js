...
let CoreMainMenuMorePage = class CoreMainMenuMorePage {
     ...
     */
    openSettings() {
        _services_navigator__WEBPACK_IMPORTED_MODULE_8__["CoreNavigator"].navigateToSitePath('settings/general');
    }
    /**
    ...
    logout() {
        ...
        _services_navigator__WEBPACK_IMPORTED_MODULE_8__["CoreNavigator"].navigate('/login', { reset: true });
    }
};
