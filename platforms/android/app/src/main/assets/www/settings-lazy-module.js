...
const sectionRoutes = [
    ...
    {
        path: 'help',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-help-help-module */ "pages-help-help-module").then(__webpack_require__.bind(null, /*! ./pages/help/help.module */ "./src/core/features/settings/pages/help/help.module.ts")).then(m => m.HelpPageModule)
    },
    {
        path: 'term',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-term-term-module */ "pages-term-term-module").then(__webpack_require__.bind(null, /*! ./pages/term/term.module */ "./src/core/features/settings/pages/term/term.module.ts")).then(m => m.TermPageModule)
    },
];
const mobileRoutes = [
    {
